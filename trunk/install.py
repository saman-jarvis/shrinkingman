...
inst["pixmaps/icon32.png"] = os.path.join(cfg["INSTALL_ICON"], "32x32", "apps", iconname)
inst["pixmaps/icon48.png"] = os.path.join(cfg["INSTALL_ICON"], "48x48", "apps", iconname)
...
remove_dir(os.path.join(cfg["INSTALL_LIB_PFX"],   "shriman"))
remove_dir(os.path.join(cfg["INSTALL_SHARE_PFX"], "shriman"))
...
binfile = os.path.join(cfg["INSTALL_LIB"], cfg["APP_SYSNAME"] + ".py")
...
os.system("update-mime-database %s" % cfg["INSTALL_MIME_PFX"])
